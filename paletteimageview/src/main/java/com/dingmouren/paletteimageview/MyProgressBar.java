...
public class MyProgressBar extends ProgressBar {
    ...
    public MyProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        innerTextSize = (int) ta.getDimension(R.styleable.CustomView_InnerTextColor, INNERTEXTCOLOR_DEFAULT);
        innerTextColor = ta.getColor(R.styleable.CustomView_InnerTextSize, INNERTEXTSIZE_DEFAULT);
